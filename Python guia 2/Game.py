...
e- Si quieres ver como es este lugar simplemnte  escribe "ver [lugar o número correspondiente] (esto se siempre se podrá realizar \n simempre y cuando la imagen se encuentre disponible)"
""")
...
while True:
    ...
    if second.lower() == ("acercarse al mentor"):
        ...
        imagen = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/campus.jpeg")
        imagen.show()
    ...
    if second.lower() == ("ir a biblioteca") or second.lower() == "ir a 7":
        ...
        if segunda_accion.lower() == ("ver biblioteca") or segunda_accion.lower() == ("ver 7"):
            ...
            imagen1 = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/bibliex.jpeg")
            imagen1.show()

            imagen2 = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/biblio1.jpeg")
            imagen2.show()

            imagen3 = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/biblio2.jpeg")
            imagen3.show()
        ...
        imagenAulasb = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/aulasb.jpeg")
        imagenAulasb.show()
        ...
        imagenCaballerizas = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/caballerizas.jpeg")
        imagenCaballerizas.show()
        ...
        imagensalap = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/salacap.jpeg")
        imagensalap.show()
        ...
        imagenchalet = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/chalet.jpeg")
        imagenchalet.show()
        ...
        imagenmanuelas = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/manuelas.jpeg")
        imagenmanuelas.show()
        ...
        imagenresidoc = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/residoc.jpeg")
        imagenresidoc.show()
        ...
        imagenmul = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/multicon.jpeg")
        imagenmul.show()
        ...
        imagenpats = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/pats.jpeg")
        imagenpats.show()
        ...
        imagencancha = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/cancha.jpeg")
        imagencancha.show()
        ...
        imagensenesc = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/senes.jpeg")
        imagensenesc.show()
        ...
        imagenbloques = Image.open("/home/user/Desktop/Data Engineer/Python_comprenhension/Python guia 2/bloques.jpeg")
        imagenbloques.show()
